...
from algo.general.bollingerband import BollingerBand
from algo.general.mixedstrategy import MixedStrategy
...
class StrategyManager:
    ...
    def run_startegy(self):
        ...
        elif self.args["strategy"] == "bollingerband":
            print(f"Running {self.args['strategy']} startegy")
            strategy = BollingerBand()
        elif self.args["strategy"] == "mixedstrategy":
            print(f"Running {self.args['strategy']} startegy")
        ...
        for data in tqdm(data["Sheet1"]):
            try:
                symbol = data['symbol']
                stock_price = GetData(symbol=symbol)
