<script lang="ts">
    ...
    async function formSubmit(e:Event)  {
        ...
        const resp = await fetch(`http://127.0.0.1:8000/run_strategy?strategy=${formInput.get('strategy')}&isDay=false&from_date=01/01/2024&to_date=28/05/2024`)
            ...
            <div class="columns is-multiline">
                        ...
                        <div class="control">
                          <div class="select">
                            <select name="strategy">
                              ...
                              <option value="rsiandmac">RSI Divergence with MAC Crossover</option>
                              <option value="atrandmaccrossover">ATR Stop-Loss with MAC Crossover</option>
                              <option value="rsioversoldbounce">RSI Oversold Bounce</option>
                              <option value="breakoutwithvolumeandrsi">Breakout Confirmation with Volume & RSI Oversold Bounce</option>
                ...
                <div class="column is-3">
                    <div class="field">
                        ...
                        <div class="control">
                          <input class="input" name="from_date" type="date" placeholder="Text input">
                        </div>
                      </div>
                </div>
                ...
                <div class="column is-3">
                    <div class="field">
                        ...
                        <div class="control">
                          <input class="input" name="to_date" type="date" placeholder="Text input">
                        </div>
                      </div>
                </div>
